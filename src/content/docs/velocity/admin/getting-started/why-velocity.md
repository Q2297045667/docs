...
当一个 Minecraft 客户端连接到另一个 Minecraft 服务器时，
服务器会返回一个唯一标识特定玩家连接的 ID。
...
Velocity 还支持社区中出现的标准库，例如社区的 [Adventure](https://github.com/KyoriPowered/adventure) 库。
我们与 Minecraft 模组社区携手合作。
